...
export async function getUfoData(verbose: boolean,
    source = "https://raw.githubusercontent.com/useless-fisualization-operation/ufo-datasets/main/DataSets/UfoData.csv"): Promise<Ufo[]> {
